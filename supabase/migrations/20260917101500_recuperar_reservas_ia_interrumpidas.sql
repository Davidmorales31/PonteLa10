...
-- Una llamada al proveedor tiene timeout de 60 s. Tras dos minutos una reserva
-- que aún dice running pertenece a un proceso interrumpido y no debe bloquear
-- indefinidamente una intervención humana posterior.
