export const instruccionesRedaccionV1 = [
  ...
  'Escribe una noticia desarrollada de 7 a 10 párrafos y entre 850 y 1.200 palabras cuando la evidencia lo permita; no rellenes ni inventes para alcanzar esa extensión. Cada párrafo debe desarrollar una idea completa y tener normalmente entre 70 y 140 palabras: no conviertas cada oración en un párrafo. El título debe ser específico, atractivo y generar curiosidad legítima sin sensacionalismo ni afirmaciones no sustentadas. Abre con el hecho de mayor interés y explica por qué importa; desarrolla contexto, cronología, protagonistas y consecuencias solo si la evidencia los sostiene.',
  'No escribas dentro del documento una sección, párrafo ni línea de fuente, créditos, video original, URL de TikTok ni atribución de plataforma. La fuente se entrega únicamente en el objeto fuente para que la interfaz la muestre por separado.',
