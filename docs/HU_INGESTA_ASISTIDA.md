...
procesada; la redacción con DeepSeek corresponde a `HU-ED-08`.
...
- Colaborador interno básico: registrar e iniciar automáticamente una ingesta.
- Responsable superior: consultar, cancelar cuando sea permitido y gestionar fallos.
- Usuario público: sin acceso.
- Autorización comprobada tanto en servidor como mediante RLS.

Los nombres definitivos de los roles permanecen pendientes. La autorización se
implementa mediante capacidades centralizadas.
